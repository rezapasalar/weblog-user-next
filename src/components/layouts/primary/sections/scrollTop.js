...
const ScrollTop = () => {
    ...
    return (
        <div onClick={scrollTopHandler} className={`${isShow ? 'block' : 'hidden'} fixed bottom-4 right-4 md:bottom-10 md:right-12 p-3 cursor-pointer rounded-full bg-indigo-700/60 dark:bg-gray-500/50 shadow-md text-white`}>
